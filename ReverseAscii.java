...
public class ReverseAscii {
    ...
    public ReverseAscii(String message, boolean alreadyEncrypted) {
    ...
    public static void main(String[] args) {
        ReverseAscii aMsg = new ReverseAscii("     qwertyuiopasdfghjklzxcvbnmQWERTYUIOPLKJHGFDSAZXCVBNM`1234567890-=[]\\;',./~!@#$%^&*()_+{}|:<>?", false);
